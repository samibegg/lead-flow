        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="px-4 py-2 bg-primary hover:bg-primary-hover-light dark:bg-primary-dark dark:hover:bg-primary-hover-dark text-white text-sm font-medium rounded-md disabled:bg-slate-300 dark:disabled:bg-slate-600 disabled:cursor-not-allowed transition-colors"
            >
              Previous
            </button>
            <button
